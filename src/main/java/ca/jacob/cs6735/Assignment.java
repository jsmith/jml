...
public class Assignment {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        algorithms.add(new ID3(ID3.MAX_LEVEL_NONE, 1));
        algorithms.add(new NaiveBayes(new Gaussian()));
        algorithms.add(new AdaBoost(new ID3(8), 300, 0.25)); // Takes at least 30 minutes for 10 iterations
        algorithms.add(new AdaBoost(new NaiveBayes(new Gaussian()), 10, 0.3)); // Takes at least 30 minutes for 10 iterations
